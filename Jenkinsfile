      ...
      steps {
          ...
          script {
              neoloadRun executable: '/home/neoload/neoload/bin/NeoLoadCmd',
                      ...
                      commandLineOption: "-nlweb -loadGenerators $WORKSPACE/infrastructure/infrastructure/neoload/lg/lg.yaml -nlwebToken $NLAPIKEY -variables host=orders,port=80,basicPath=${BASICCHECKURI}",
          ...
          steps {
              script {
                  neoloadRun executable: '/home/neoload/neoload/bin/NeoLoadCmd',
                          ...
                          commandLineOption: "-nlweb -loadGenerators $WORKSPACE/infrastructure/infrastructure/neoload/lg/lg.yaml -nlwebToken $NLAPIKEY -variables host=orders,port=80",
      ...
      steps {
          script {
              neoloadRun executable: '/home/neoload/neoload/bin/NeoLoadCmd',
                      ...
                      commandLineOption: "-nlweb -loadGenerators $WORKSPACE/infrastructure/infrastructure/neoload/lg/lg.yaml -nlwebToken $NLAPIKEY -variables carts_host=orders,carts_port=80,orderPath=${ORDERSURI}",
